...
public class Fourmis
{
	...
	private static double ALPHA = 2;//paramètre pour l'intensité de la piste de phéromone
	private static double BETA = 3.5;//paramètre pour la visibilité des noeuds (1/distance)
